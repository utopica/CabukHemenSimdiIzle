...
{
    public class ScenaristReadRepository : ReadRepository<Scenarist>, IScenaristReadRepository
    {
        public ScenaristReadRepository(AppDbContext context) : base(context)
        {
        }
    }
}
